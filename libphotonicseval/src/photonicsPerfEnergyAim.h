// File: photonicsPerfEnergyAim.h
// PHOTONICSeval Simulator - Performance Energy Models
// Copyright (c) 2024 University of Virginia
// This file is licensed under the MIT License.
// See the LICENSE file in the root of this repository for more details.

#ifndef LAVA_PHOTONICS_PERF_ENERGY_AIM_H
#define LAVA_PHOTONICS_PERF_ENERGY_AIM_H
...
//! @class  photonicsPerfEnergyAim
//! @brief  PHOTONICS performance energy model for bank-level PHOTONICS family
class photonicsPerfEnergyAim : public photonicsPerfEnergyBase
{
public:
  photonicsPerfEnergyAim(const photonicsPerfEnergyModelParams& params) : photonicsPerfEnergyBase(params) {}
  virtual ~photonicsPerfEnergyAim() {}
  ...
  virtual photonicseval::perfEnergy getPerfEnergyForMac(PhotonicsCmdEnum cmdType, const photonicsObjInfo& obj) const override;
