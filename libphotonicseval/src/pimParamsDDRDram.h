// File: photonicsParamsDDRDram.h
// PHOTONICSeval Simulator - DDR DRAM parameters
// Copyright (c) 2024 University of Virginia
// This file is licensed under the MIT License.
// See the LICENSE file in the root of this repository for more details.

#ifndef LAVA_PHOTONICS_PARAMS_DDR_DRAM_H
#define LAVA_PHOTONICS_PARAMS_DDR_DRAM_H
...
class photonicsParamsDDRDram : public photonicsParamsDram
{
public:
  photonicsParamsDDRDram();
  photonicsParamsDDRDram(std::unordered_map<std::string, std::string> params);
  ~photonicsParamsDDRDram() override = default;
