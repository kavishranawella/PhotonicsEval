// File: photonicsParamsGDDRDram.h
// PHOTONICSeval Simulator - GDDR DRAM parameters
// Copyright (c) 2024 University of Virginia
// This file is licensed under the MIT License.
// See the LICENSE file in the root of this repository for more details.

#ifndef LAVA_PHOTONICS_PARAMS_GDDR_DRAM_H
#define LAVA_PHOTONICS_PARAMS_GDDR_DRAM_H

#include <string>
#include <unordered_map>
#include "photonicsParamsDram.h"

//! @class  photonicsParamsGDDRDram
//! @brief  DRAM parameters (DRAMsim3 compatible)
class photonicsParamsGDDRDram : public photonicsParamsDram
{
public:
  photonicsParamsGDDRDram();
  photonicsParamsGDDRDram(std::unordered_map<std::string, std::string> params);
  ~photonicsParamsGDDRDram() override = default;
