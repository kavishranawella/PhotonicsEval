// File: photonicsPerfEnergyBankLevel.cc
...
//! @brief  Perf energy model of bank-level PHOTONICS for func1
photonicseval::perfEnergy
photonicsPerfEnergyBankLevel::getPerfEnergyForFunc1(PhotonicsCmdEnum cmdType, const photonicsObjInfo& obj, const photonicsObjInfo& objDest) const
{
...
//! @brief  Perf energy model of bank-level PHOTONICS for func2
photonicseval::perfEnergy
photonicsPerfEnergyBankLevel::getPerfEnergyForFunc2(PhotonicsCmdEnum cmdType, const photonicsObjInfo& obj, const photonicsObjInfo& objSrc2, const photonicsObjInfo& objDest) const
{
  double msRuntime = 0.0;
  double mjEnergy = 0.0;
  double msRead = 0.0;
...
//! @brief  Perf energy model of bank-level PHOTONICS for reduction sum
photonicseval::perfEnergy
photonicsPerfEnergyBankLevel::getPerfEnergyForReduction(PhotonicsCmdEnum cmdType, const photonicsObjInfo& obj, unsigned numPass) const
{
  double msRuntime = 0.0;
  double mjEnergy = 0.0;
  double msRead = 0.0;
  ...
  switch (cmdType) {
    ...
    default:
      printf("PHOTONICS-Warning: Unsupported reduction command for bank-level PHOTONICS: %s\n", photonicsCmd::getName(cmdType, "").c_str());
      break;
    }
...
//! @brief  Perf energy model of bank-level PHOTONICS for broadcast
photonicseval::perfEnergy
photonicsPerfEnergyBankLevel::getPerfEnergyForBroadcast(PhotonicsCmdEnum cmdType, const photonicsObjInfo& obj) const
{
  double msRuntime = 0.0;
  double mjEnergy = 0.0;
  double msRead = 0.0;
...
//! @brief  Perf energy model of bank-level PHOTONICS for rotate
photonicseval::perfEnergy
photonicsPerfEnergyBankLevel::getPerfEnergyForRotate(PhotonicsCmdEnum cmdType, const photonicsObjInfo& obj) const
{
  double msRuntime = 0.0;
  double mjEnergy = 0.0;
  double msRead = 0.0;
...
//! @brief  Perf energy model of bank-level PHOTONICS for prefix-sum
photonicseval::perfEnergy
photonicsPerfEnergyBankLevel::getPerfEnergyForPrefixSum(PhotonicsCmdEnum cmdType, const photonicsObjInfo& obj) const
{
  double msRuntime = 0.0;
  double mjEnergy = 0.0;
  double msRead = 0.0;
