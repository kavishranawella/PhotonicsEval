// File: photonicsParamsLPDDRDram.h
// PHOTONICSeval Simulator - LPDDR DRAM parameters
// Copyright (c) 2024 University of Virginia
// This file is licensed under the MIT License.
// See the LICENSE file in the root of this repository for more details.

#ifndef LAVA_PHOTONICS_PARAMS_LPDDR_DRAM_H
#define LAVA_PHOTONICS_PARAMS_LPDDR_DRAM_H

#include <string>
#include <unordered_map>
#include "photonicsParamsDram.h"

//! @class  photonicsParamsLPDDRDram
//! @brief  DRAM parameters (DRAMsim3 compatible)
class photonicsParamsLPDDRDram : public photonicsParamsDram
{
public:
  photonicsParamsLPDDRDram();
  photonicsParamsLPDDRDram(std::unordered_map<std::string, std::string> params);
  ~photonicsParamsLPDDRDram() override = default;
