// File: photonicsParamsLPDDRDram.cc
...
//! @brief  photonicsParamsLPDDRDram ctor (based on LPDDR4_8Gb_x16_2400.ini from DRAMsim3)
photonicsParamsLPDDRDram::photonicsParamsLPDDRDram()
  : // [dram_structure]
    m_protocol("LPDDR4"),
    m_bankgroups(2),
    m_banksPerGroup(4),
...
//! @brief  photonicsParamsLPDDRDram ctor with a config file
photonicsParamsLPDDRDram::photonicsParamsLPDDRDram(std::unordered_map<std::string, std::string> params)
{
  try {
